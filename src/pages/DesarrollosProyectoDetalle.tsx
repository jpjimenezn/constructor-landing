...
import { findDesarrolloProjectBySlug } from "@/lib/desarrollosProjects";

const DesarrollosProyectoDetalle = () => {
  const { slug, projectSlug } = useParams();
  const data = useMemo(
    () =>
      slug && projectSlug
        ? findDesarrolloProjectBySlug(slug, projectSlug)
        : undefined,
    [slug, projectSlug],
  );
...
export default DesarrollosProyectoDetalle;
